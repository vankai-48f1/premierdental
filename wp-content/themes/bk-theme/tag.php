<?php
    get_header();
    get_template_part('partials/header', 'img'); 
?>

<section class="category-page main-content">
    <div class="container display-grid">
        <article class="col-md-8 left-side" id="content">
...
<input class="cat" value="<?php echo get_query_var('cat'); ?>"></input>
